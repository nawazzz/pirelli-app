        ...
        <Flex maxW='1440px' justifyContent='center'>
            <Flex flexDir='column' gap='2'>
                ...
                <Flex flexDir='column' mt='8' gap='2' position='relative'>
                    <Flex position='absolute' zIndex='2' w='44px' h='44px' alignItems='center' justifyContent='center' top='5px' left='2px'>
                ...
                <Flex justifyContent='space-between' mt='12'>
                    <Button color='#FEFEFE' bg='rgba(255, 255, 255, 0.1)' _hover={{border: '1px solid', borderColor: '#E2E8F0', bg: 'transparent'}}>bellinzona</Button>
                    <Button color='#FEFEFE' bg='rgba(255, 255, 255, 0.1)' _hover={{border: '1px solid', borderColor: '#E2E8F0', bg: 'transparent'}}>locarno</Button>
                    <Button color='#FEFEFE' bg='rgba(255, 255, 255, 0.1)' _hover={{border: '1px solid', borderColor: '#E2E8F0', bg: 'transparent'}}>lugano</Button>
                    <Button color='#FEFEFE' bg='rgba(255, 255, 255, 0.1)' _hover={{border: '1px solid', borderColor: '#E2E8F0', bg: 'transparent'}}>mendrisio</Button>
                    <Button color='#FEFEFE' bg='rgba(255, 255, 255, 0.1)' _hover={{border: '1px solid', borderColor: '#E2E8F0', bg: 'transparent'}}>bioggio</Button>
                    <Button color='#FEFEFE' bg='rgba(255, 255, 255, 0.1)' _hover={{border: '1px solid', borderColor: '#E2E8F0', bg: 'transparent'}}>camorino</Button>
                </Flex>
            </Flex>
