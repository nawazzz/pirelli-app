import { VStack, Container, Flex, Text, Button, Image, Box, useMediaQuery } from '@chakra-ui/react'
...
class ProductSectionComponent extends React.Component {
    ...
    render() {
        ...
        return(
            ...
            //         <Flex fontSize='60px' fontWeight='600' gap='3' w='100%' justifyContent='flex-start' lineHeight={{base: '1', md: '3.75rem'}} flexDir={{base: 'row', md: 'row'}}>
            //             Scopri i nostri
            //             <Text as='span' color='#B3B6B9'>prodotti</Text>
            //         </Flex>
            //         <Flex w='100%' gap='6' justifyContent='center' py='10' zIndex='-1' flexWrap={{base:'wrap', sm: 'wrap', md: 'wrap'}} flexDir={{base: 'column', md: 'row', sm: 'column'}}>
            ...
            <VStack w='100%' px={{base: '60px', md: '120px'}} mx='auto' maxW='1440px'>
                <Flex w='100%' flexDir='column'>
                    <Flex fontSize='60px' fontWeight='600' gap='3' w='100%' justifyContent='center' lineHeight={{base: '1', md: '3.75rem'}} flexDir={{base: 'row', md: 'row'}}>
                        Scopri i nostri
                        <Text as='span' color='#B3B6B9'>prodotti</Text>
                    </Flex>
                    <Flex w='100%' gap='6' justifyContent='center' py='10' zIndex='-1' flexWrap={{base:'wrap', sm: 'wrap', md: 'wrap'}} flexDir={{base: 'column', md: 'row', sm: 'column'}}>
                        ...
                        isVisible
                            ...
                            spaceBetween={24}
                            slidesPerView={window.screen.width < 1024 ? 2 : 3}
